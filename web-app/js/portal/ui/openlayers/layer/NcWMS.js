...
OpenLayers.Layer.NcWMS = OpenLayers.Class(OpenLayers.Layer.WMS, {
    ...
    _setExtraLayerInfoFromNcwms: function() {
        Ext.Ajax.proxyRequestJSON({
            ...
            success: function(resp, options) {
                try {
                    this.extraLayerInfo = Ext.JSON.decode(resp.responseText);
    ...
    _loadTimeSeriesDates: function() {
        ...
        Ext.Ajax.request({
            ...
            success: function(resp, options) {
                try {
                    this._parseDatesWithDataAsync(Ext.JSON.decode(resp.responseText));
                }
                catch (e) {
    ...
    _loadStyles: function() {
        ...
        Ext.Ajax.request({
            ...
            success: function(resp, options) {
                try {
                    this._stylesLoaded(Ext.JSON.decode(resp.responseText));
                }
                catch (e) {
    ...
    _fetchTimeSeriesForDay: function(date) {
        ...
        Ext.Ajax.request({
            ...
            success: function(resp, options) {
                try {
                    var dateArray = Ext.JSON.decode(resp.responseText);
